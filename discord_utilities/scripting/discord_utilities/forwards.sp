...
public void OnLibraryAdded(const char[] szLibrary)
{
	...
	else if(StrEqual(szLibrary, "WarnSystem")) g_bWarnSystem = true;
	...
	else if(StrEqual(szLibrary, "report_system")) g_bReportSystem = true;
}
...
public void OnLibraryRemoved(const char[] szLibrary)
{
	...
	else if(StrEqual(szLibrary, "WarnSystem")) g_bWarnSystem = false;
	...
	else if(StrEqual(szLibrary, "report_system")) g_bReportSystem = false;
}
...
public void OnAllPluginsLoaded()
{
	...
	g_bWarnSystem = LibraryExists("WarnSystem");
	...
	g_bReportSystem = LibraryExists("report_system");
}
...
public int OnSettingsChanged(ConVar convar, const char[] oldVal, const char[] newVal)
{
	...
	else if(convar == g_cWarnSystem_Webhook)
	{
		strcopy(g_sWarnSystem_Webhook, sizeof(g_sWarnSystem_Webhook), newVal);
	}
	else if(convar == g_cWarnSystem_BotName)
	{
		strcopy(g_sWarnSystem_BotName, sizeof(g_sWarnSystem_BotName), newVal);
	}
	else if(convar == g_cWarnSystem_BotAvatar)
	{
		strcopy(g_sWarnSystem_BotAvatar, sizeof(g_sWarnSystem_BotAvatar), newVal);
	}
	else if(convar == g_cWarnSystem_Color)
	{
		strcopy(g_sWarnSystem_Color, sizeof(g_sWarnSystem_Color), newVal);
	}
	else if(convar == g_cWarnSystem_Content)
	{
		strcopy(g_sWarnSystem_Content, sizeof(g_sWarnSystem_Content), newVal);
	}
	else if(convar == g_cWarnSystem_FooterIcon)
	{
		strcopy(g_sWarnSystem_FooterIcon, sizeof(g_sWarnSystem_FooterIcon), newVal);
	}
	else if(convar == g_cWarnSystem_Webhook)
	{
		strcopy(g_sWarnSystem_Webhook, sizeof(g_sWarnSystem_Webhook), newVal);
